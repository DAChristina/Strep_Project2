...
pars <- list(dt = 1,
             ...
             beta_0 = 0.1,
             beta_1 = 0.6,
             delta = (1/1000), # Probability of people developing disease
             # (https://academic.oup.com/jid/article/206/7/1020/806330)
             sigma_1 = (1/15.75), # fixed per-day, carriage duration (95% CI 7.88-31.49) (Serotype 1) (Chaguza et al., 2021)
             sigma_2 = (1/1) # assumed as acute phase
...
R0 <- (beta/(pars$delta+pars$sigma_1)) +  ((pars$delta)*(beta)) / ((pars$delta + 192/(4064*4745))*(pars$sigma_2 + 192/(4064*4745))) # print R0
max(R0)
min(R0)
# plot(time, R0)
