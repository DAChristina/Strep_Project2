...
filter$run(save_history = TRUE, pars = list(dt = dt,
                                            ...
                                            I_ini = 10,
                                            beta = (1/15.75)*1.2
                                            # sigma = (1/15.75) 15.75 days (95% CI 7.88-31.49) (Serotype 1) (Chaguza et al., 2021)
))
...
beta <- mcstate::pmcmc_parameter("beta", (1/15.75)*1.2, min = 0.01860361/365) # Invasiveness per carrier per day
# sigma <- mcstate::pmcmc_parameter("sigma", (1/15.75), min = 0, prior = function(p)
